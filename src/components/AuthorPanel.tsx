import { Rocket, TrendingUp, Upload } from "lucide-react";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Textarea } from "@/components/ui/textarea";

const uploadedBooks = [
  { id: 1, title: "THER SAGA", earnings: "0.15 ETH", color: "from-primary to-secondary" },
  { id: 2, title: "STER1€CS", earnings: "0.15 ETH", color: "from-secondary to-accent" },
  { id: 3, title: "MILK", earnings: "0.15 ETH", color: "from-accent to-primary" },
  { id: 4, title: "THE ETHER SAGA", earnings: "0.15 ETH", color: "from-primary to-accent" },
  { id: 5, title: "BOMIN", earnings: "0.15 ETH", color: "from-secondary to-primary" },
];
                ...
                {uploadedBooks.map((book, index) => (
                  ...
                  >
                    <div className={`aspect-square rounded-lg bg-gradient-to-br ${book.color} pixel-art flex items-center justify-center border-2 border-border`}>
                      <span className="text-2xl font-black text-primary-foreground drop-shadow-lg">{book.title.slice(0, 4)}</span>
                    </div>
