export const MetaMaskIcon = ({ className = "w-6 h-6" }: { className?: string }) => {
  return (
    <svg 
      className={className} 
    ...
    >
      ...
      <polygon className="st1" points="103.6,138.2 87.8,162.1 143.8,164.6 141.9,104.1" />
      ...
      <polygon className="st4" points="110.6,185.2 130.6,176.1 138.8,193.5 143.8,164.6 87.8,162.1" />
      ...
      <polygon className="st5" points="143.8,164.6 138.8,193.5 145.1,227.6 146.6,182.7" />
      <polygon className="st5" points="174.6,164.6 172,182.6 173.4,227.6 179.8,193.5" />
      <polygon className="st6" points="179.8,193.5 173.4,227.6 177.9,230.9 207.1,208.1 208.1,185.2" />
      <polygon className="st6" points="110.6,185.2 111.4,208.1 140.6,230.9 145.1,227.6 138.8,193.5" />
      ...
      <polygon className="st8" points="177.9,230.9 173.4,227.6 145.1,227.6 140.6,230.9 138.1,253 140.4,250.8 178.1,250.8 180.6,253" />
      ...
      <polygon className="st6" points="174.6,164.6 177.9,106.9 193.1,65.8 125.6,65.8 140.6,106.9 143.8,164.6 145,182.8 145.1,227.6 173.4,227.6 173.6,182.8" />
    </svg>
  );
};
